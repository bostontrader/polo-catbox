...
test(t => {
  ...
  // 5. buy  is completely fulfilled and consumes 1/4 of dt 1001 (the remainder) and 3/4 of dt 1002.
  ...
  // 6. buy is completely fulfilled and consumes all open orders < 0.22 and 1/2 of 1003,0.022
  ...
  // 7. buy tries to consume more than is available at 0.27 but only gets what's available.
  actual = engine.buy({apiKey: 'me', currencyPair, dt: 2000, rate: 0.027, amount: 3, immediateOrCancel: 1})
  expected = {
    orderNumber: '1',
    resultingTrades: [
      {amount: 0.5, date: engine.desiredTradeDate, orderNumber: undefined, rate: 0.022, total: 0.011, tradeID: '1', type: 'buy', baseCurrency, quoteCurrency},
      {amount: 1, date: engine.desiredTradeDate, orderNumber: undefined, rate: 0.022, total: 0.022, tradeID: '1', type: 'buy', baseCurrency, quoteCurrency},
      {amount: 1, date: engine.desiredTradeDate, orderNumber: undefined, rate: 0.027, total: 0.027, tradeID: '1', type: 'buy', baseCurrency, quoteCurrency}
    ],
    amountUnfilled: 0.5
  }
  t.deepEqual(actual, expected)
