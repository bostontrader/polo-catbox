...
test.serial(t => {
  ...
  actual = engine.buy({apiKey: 'me', currencyPair: 'BTC_LTC', 'dt': 2000, rate: 0.021, amount: 1.0, postOnly: 1})
  ...
  t.deepEqual(
    engine.orders2Buy,
    [{apiKey: 'me', currencyPair: 'BTC_LTC', dt: 2000, rate: 0.018, amount: 1, postOnly: 1}]
  )
