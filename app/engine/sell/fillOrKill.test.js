...
test.serial(t => {
  ...
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.023, amount: 1.0, fillOrKill:1})
  ...
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.019, amount: 1.75, fillOrKill:1})
  expected = {
    "orderNumber":"1",
    "resultingTrades":[
  ...
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.019, amount: 1, fillOrKill:1})
  expected = {
    "orderNumber":"1",
    "resultingTrades":[
  ...
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.020, amount: 2.75, fillOrKill:1})
  expected = {
    "orderNumber":"1",
    "resultingTrades":[
      { amount: 0.25, date: '2017-10-07 11:55:18', rate: 0.022, total: 0.0055, tradeID: '1', type: 'sell' },
      { amount: 1, date: '2017-10-07 11:55:18', rate: 0.022, total: 0.022, tradeID: '1', type: 'sell' },
      { amount: 1, date: '2017-10-07 11:55:18', rate: 0.022, total: 0.022, tradeID: '1', type: 'sell' },
      { amount: 0.5, date: '2017-10-07 11:55:18', rate: 0.020, total: 0.01, tradeID: '1', type: 'sell' }
    ]
  }
  ...
  expected = [
    ...
    {apiKey:'others', currencyPair:'BTC_LTC', 'dt': 1003, rate: 0.022, amount: 0},
    {apiKey:'others', currencyPair:'BTC_LTC', 'dt': 1003, rate: 0.020, amount: 0.5},
    {apiKey:'others', currencyPair:'BTC_LTC', 'dt': 1009, rate: 0.020, amount: 1.0}
  ]
  t.deepEqual(actual, expected)

  // 5. sell tries to consume more than is available at 0.19 and gets nothing.
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.019, amount: 3, fillOrKill:1})
  expected = { error: poloConstants.UNABLE_TO_FILL_ORDER_COMPLETELY }
  t.deepEqual(actual, expected)
  ...
  actual = engine.sell({apiKey:'me', currencyPair:'BTC_LTC', 'dt': 2000, rate: 0.020, amount: 0.5, fillOrKill:1})
  expected = {
    orderNumber: '1',
    resultingTrades: [
      { amount: 0.5, date: '2017-10-07 11:55:18', rate: 0.020, total: 0.01, tradeID: '1', type: 'sell'}
  ...
  // 7. After all of this, there should not be any sell orders on the books.
