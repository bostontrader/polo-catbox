...
test.serial(t => {
  ...
  expected = {
    ...
    resultingTrades: [
      ...
      {amount: 1, date, rate: 0.022, total: 0.022, tradeID: '1', type: 'sell', baseCurrency, quoteCurrency},
      {amount: 1, date, rate: 0.022, total: 0.022, tradeID: '1', type: 'sell', baseCurrency, quoteCurrency},
      {amount: 0.5, date, rate: 0.020, total: 0.010, tradeID: '1', type: 'sell', baseCurrency, quoteCurrency}
    ],
    amountUnfilled: 0
  }
  t.deepEqual(actual, expected)
  ...
  expected = {
    orderNumber: '1',
    resultingTrades: [
      {amount: 0.5, date, rate: 0.02, total: 0.01, tradeID: '1', type: 'sell', baseCurrency, quoteCurrency},
      {amount: 1, date, rate: 0.02, total: 0.02, tradeID: '1', type: 'sell', baseCurrency, quoteCurrency}
    ],
    amountUnfilled: 1.5
  }
  t.deepEqual(actual, expected)
