...
test.serial(t => {
  ...
  expected = [{apiKey: 'me', currencyPair: 'BTC_LTC', dt: 2000, rate: 0.023, amount: 1}]
  t.deepEqual(actual, expected)
  ...
  // The orders to sell should not have a new order
  actual = engine.orders2Sell.sort(sort_CPASC_RateDESC_DtASC)
  expected = [{apiKey: 'me', currencyPair: 'BTC_LTC', dt: 2000, rate: 0.023, amount: 1}]
  t.deepEqual(actual, expected)
  ...
  // The orders to sell should a new order
  actual = engine.orders2Sell.sort(sort_CPASC_RateDESC_DtASC)
  expected = [
