...
test.serial(t => {
  ...
  // 3. Attempt to sell at a price higher than dt 1000's bid price.  Should be no sale and a new sell order should be posted.
  ...
  // 5. sell tries to consume more than is available at 0.022.  This will result in a residual sell order.
