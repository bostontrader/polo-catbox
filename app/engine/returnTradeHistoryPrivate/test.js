...
test.serial(t => {
  ...
  engine.buy({apiKey: 'others', currencyPair: 'BTC_LTC', dt: 2000, rate: 0.018, amount: 2.0, postOnly: 1})
  engine.desiredTradeDate = tradeDate1
  engine.sell({apiKey: 'me', currencyPair: 'BTC_LTC', dt: tradeDate1, rate: 0.017, amount: 2.0})
  ...
  // 4. Make a third trade, this time for a 2nd currency
